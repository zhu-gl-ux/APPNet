...
class Cityscapes(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        name = item["name"]
        #print(os.path.join(self.root, "list/cityscapes", item["img"]))
        image = cv2.imread(os.path.join(self.root, "list/cityscapes", item["img"]), cv2.IMREAD_COLOR)
        size = image.shape
        ...
        label = cv2.imread(os.path.join(self.root, "list/cityscapes", item["label"]), cv2.IMREAD_GRAYSCALE)
