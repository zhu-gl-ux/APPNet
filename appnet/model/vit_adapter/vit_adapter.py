...
from appnet.ops.modules import MSDeformAttn
...
class ViTAdapter(TIMMVisionTransformer):
    def __init__(self, pretrain_size=224, num_heads=12, conv_inplane=64, n_points=4,
                 ...
                 cffn_ratio=0.25, deform_ratio=1.0, add_vit_feature=True, pretrained_bacbone=None,
                 use_extra_extractor=True, with_cp=False, *args, **kwargs):

        super().__init__(num_heads=num_heads, pretrained_bacbone=pretrained_bacbone,
