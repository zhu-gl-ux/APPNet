    ...
    def read_files(self):
        ...
        if 'test' in self.list_path:
            for item in self.img_list:
                image_path = item
                image_path = os.path.join('./AppNet/data/list/cityscapes',"".join(image_path))
            ...
            for item in self.img_list:
                ...
                image_path = os.path.join('./AppNet/data/list/cityscapes',image_path)
                label_path = os.path.join('./AppNet/data/list/cityscapes',label_path)
